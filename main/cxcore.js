"use strict"
/*Compiled using Cheerp (R) by Leaning Technologies Ltd*/ var a62 = Math.imul
var a63 = Math.fround
var oSlot = 0
var nullArray = [null]
...
function Ve(i, g) {
    ...
    a: if ((c & 65535) !== 0) {
        ...
        kl(HEAP32[(16 + (HEAP32[815258] | 0)) >> 2] | 0, 0, 1)
...
function ayI(g, h, e) {
    ...
    a: if ((e & 255) < 192) {
        if ((c | 0) === 0) {
            if (e << 24 <= -16777216) tr(2129412 | 0, 77)
            q5 = a
        } else {
            if (((a & 192) | 0) !== 128) tr(2129424 | 0, 63)
            a = ((q5 << 6) + (a & 63)) | 0
            q5 = a
            c = (c - 1) | 0
            vc = c
...
function TS(k, i, g, e, c, a) {
    avo(k, i, g, e, c, HEAP8, a >> 0)
}
function dN(i, g, e, c, a) {
    avm(i, g, e, HEAP8, c >> 0, a)
}
function rf(c, a) {
    Z9(HEAP8, c >> 0, a)
}
...
a7n.promise = a7r("cxcore.wasm")
    .then((a) => WebAssembly.instantiate(a, { i: { memory: memory, Uh: Uh, ayK: ayK, ayT: ayT, TQ: TQ, p8: p8, aGk: aGk, l4: l4, aE9: aE9, aGx: aGx, vx: vx, aII: aII, TR: TR, aGE: aGE, rS: rS, aGB: aGB, vy: vy, aIl: aIl, aE3: aE3, aGl: aGl, aGj: aGj, aHg: aHg, aa_: aa_, au4: au4, aE4: aE4, Lm: Lm, ay6: a7n, abl: abl, aID: aID, kn: kn, abL: abL, aa$: aa$, abc: abc, oy: oy, ED: ED, fZ: fZ, rf: rf, as$: as$, m4: m4, EG: EG, eT: eT, ay7: ay7, dN: dN, gr: gr, TS: TS, acC: acC, acB: acB, F1: F1, nZ: nZ, alI: alI, alB: alB, aHP: aHP, ahF: ahF, KY: KY, KR: KR, KO: KO, KJ: KJ, TT: TT, KE: KE, KB: KB, Ia: Ia, td: td, P3: P3, aIr: aIr, g3: g3, ar0: ar0, QU: QU, ES: ES, oB: oB, adV: adV, Y: Y, adi: adi, uv: uv, aak: aak, TU: TU, ajK: ajK, dz: Date.now, rE: rE, AX: AX, yt: yt, acc: acc, avh: avh, kk: kk, v0: v0, v_: v_, Ww: Ww, Wv: Wv, Wu: Wu, Wt: Wt, Ws: Ws, Wr: Wr, Wq: Wq, Wp: Wp, WA: WA, Ep: Ep, aal: aal, v1: v1, Vw: Vw, ru: ru, vV: vV, Vx: Vx, a68: Math.atan2, a7c: Math.pow, a7l: a7l } }))
    .then((a) => {
